...
Namespace Cart
	...
	Partial Public Class FR_Cart
		...
		Private _ShipDetailsID As System.Nullable(Of Long)
		...
		Private _ShipVAT As System.Nullable(Of Double)
    ...
    End Sub
    Partial Private Sub OnShipVATChanging(value As System.Nullable(Of Double))
    End Sub
    ...
    #End Region
		...
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_ShipDetailsID", DbType:="BigInt")>  _
		Public Property ShipAddressBookID() As System.Nullable(Of Long)
			Get
				Return Me._ShipDetailsID
			End Get
			Set
				If (Me._ShipDetailsID.Equals(value) = false) Then
		...
		Public Property ShipVAT() As System.Nullable(Of Double)
			Get
				Return Me._ShipVAT
			End Get
			Set
    ...
    #End Region
		...
		<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="FR_Cart_FR_Cart_Content", Storage:="_FR_Cart", ThisKey:="CartID", OtherKey:="CartID", IsForeignKey:=true)>  _
