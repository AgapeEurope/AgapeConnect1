...
Namespace MPD
	...
	Partial Public Class AP_mpdCalc_Question
		...
		Private _NetRateType As String
		
		Private _TaxRate1 As System.Nullable(Of Double)
		
		Private _TaxRate1Threshold As System.Nullable(Of Decimal)
		
		Private _TaxRate2 As System.Nullable(Of Double)
		
		Private _TaxRate2Threshold As System.Nullable(Of Decimal)
		
		Private _TaxRate3 As System.Nullable(Of Double)
		
		Private _TaxRate3Threshold As System.Nullable(Of Decimal)
    ...
    End Sub
    Partial Private Sub OnNetRateTypeChanging(value As String)
    End Sub
    Partial Private Sub OnNetRateTypeChanged()
    End Sub
    Partial Private Sub OnTaxRate1Changing(value As System.Nullable(Of Double))
    End Sub
    Partial Private Sub OnTaxRate1Changed()
    End Sub
    Partial Private Sub OnTaxRate1ThresholdChanging(value As System.Nullable(Of Decimal))
    End Sub
    Partial Private Sub OnTaxRate1ThresholdChanged()
    End Sub
    Partial Private Sub OnTaxRate2Changing(value As System.Nullable(Of Double))
    End Sub
    Partial Private Sub OnTaxRate2Changed()
    End Sub
    Partial Private Sub OnTaxRate2ThresholdChanging(value As System.Nullable(Of Decimal))
    End Sub
    Partial Private Sub OnTaxRate2ThresholdChanged()
    End Sub
    Partial Private Sub OnTaxRate3Changing(value As System.Nullable(Of Double))
    End Sub
    Partial Private Sub OnTaxRate3Changed()
    End Sub
    Partial Private Sub OnTaxRate3ThresholdChanging(value As System.Nullable(Of Decimal))
    End Sub
    Partial Private Sub OnTaxRate3ThresholdChanged()
    End Sub
    #End Region
		...
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_NetRateType", DbType:="NVarChar(20)")>  _
		Public Property NetRateType() As String
			Get
				Return Me._NetRateType
			End Get
			Set
				If (String.Equals(Me._NetRateType, value) = false) Then
					Me.OnNetRateTypeChanging(value)
					Me.SendPropertyChanging
					Me._NetRateType = value
					Me.SendPropertyChanged("NetRateType")
					Me.OnNetRateTypeChanged
				End If
			End Set
		End Property
		
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_TaxRate1", DbType:="Float")>  _
		Public Property TaxRate1() As System.Nullable(Of Double)
			Get
				Return Me._TaxRate1
			End Get
			Set
				If (Me._TaxRate1.Equals(value) = false) Then
					Me.OnTaxRate1Changing(value)
					Me.SendPropertyChanging
					Me._TaxRate1 = value
					Me.SendPropertyChanged("TaxRate1")
					Me.OnTaxRate1Changed
				End If
			End Set
		End Property
		
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_TaxRate1Threshold", DbType:="Money")>  _
		Public Property TaxRate1Threshold() As System.Nullable(Of Decimal)
			Get
				Return Me._TaxRate1Threshold
			End Get
			Set
				If (Me._TaxRate1Threshold.Equals(value) = false) Then
					Me.OnTaxRate1ThresholdChanging(value)
					Me.SendPropertyChanging
					Me._TaxRate1Threshold = value
					Me.SendPropertyChanged("TaxRate1Threshold")
					Me.OnTaxRate1ThresholdChanged
				End If
			End Set
		End Property
		
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_TaxRate2", DbType:="Float")>  _
		Public Property TaxRate2() As System.Nullable(Of Double)
			Get
				Return Me._TaxRate2
			End Get
			Set
				If (Me._TaxRate2.Equals(value) = false) Then
					Me.OnTaxRate2Changing(value)
					Me.SendPropertyChanging
					Me._TaxRate2 = value
					Me.SendPropertyChanged("TaxRate2")
					Me.OnTaxRate2Changed
				End If
			End Set
		End Property
		
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_TaxRate2Threshold", DbType:="Money")>  _
		Public Property TaxRate2Threshold() As System.Nullable(Of Decimal)
			Get
				Return Me._TaxRate2Threshold
			End Get
			Set
				If (Me._TaxRate2Threshold.Equals(value) = false) Then
					Me.OnTaxRate2ThresholdChanging(value)
					Me.SendPropertyChanging
					Me._TaxRate2Threshold = value
					Me.SendPropertyChanged("TaxRate2Threshold")
					Me.OnTaxRate2ThresholdChanged
				End If
			End Set
		End Property
		
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_TaxRate3", DbType:="Float")>  _
		Public Property TaxRate3() As System.Nullable(Of Double)
			Get
				Return Me._TaxRate3
			End Get
			Set
				If (Me._TaxRate3.Equals(value) = false) Then
					Me.OnTaxRate3Changing(value)
					Me.SendPropertyChanging
					Me._TaxRate3 = value
					Me.SendPropertyChanged("TaxRate3")
					Me.OnTaxRate3Changed
				End If
			End Set
		End Property
		
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_TaxRate3Threshold", DbType:="Money")>  _
		Public Property TaxRate3Threshold() As System.Nullable(Of Decimal)
			Get
				Return Me._TaxRate3Threshold
			End Get
			Set
				If (Me._TaxRate3Threshold.Equals(value) = false) Then
					Me.OnTaxRate3ThresholdChanging(value)
					Me.SendPropertyChanging
					Me._TaxRate3Threshold = value
					Me.SendPropertyChanged("TaxRate3Threshold")
					Me.OnTaxRate3ThresholdChanged
				End If
			End Set
		End Property
