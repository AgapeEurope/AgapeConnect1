<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DocumentTreeView.ascx.vb" Inherits="DotNetNuke.Modules.AgapeDocuments.DocumentTreeView" %>
<%@ Register TagPrefix="dnn" TagName="TextEditor" Src="~/controls/TextEditor.ascx"%>




<div style="background-color: White; padding: 25px; width: 450px; ">
<%--<asp:DataList
...
<asp:TreeView ID="tvFolders" runat="server" NodeIndent="10"  
        CollapseImageUrl="/DesktopModules/AgapeConnect/Documents/images/ArrowWinD.gif" ExpandImageUrl="/DesktopModules/AgapeConnect/Documents/images/ArrowWinR.gif" 
