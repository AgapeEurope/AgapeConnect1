...
<div>
 <input type="button" value="New Image"  onclick="showPopup<%= NewImage.ClientId %>();" class="aButton" width="100px"  style="font-size: 8pt ;width=100px;" />
<asp:Button ID="btnUpdate" runat="server" Text="Update" Width="100px" CssClass="aButton" style="font-size: 8pt" />
</div>
</div>
...
<div id="NewImage" runat="server" style="text-align: center; ">
 ...
 <asp:Button ID="btnUpload" runat="server" Text="Upload" Width="100px" CssClass="aButton" Enabled="false" />
</div>
