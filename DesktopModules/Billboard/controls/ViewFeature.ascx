<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ViewFeature.ascx.vb" Inherits="DesktopModules_Billboard_controls_ViewFeature" ClassName="DesktopModules_Billboard_controls_ViewFeature" %>
...
<tr>
<td align="left">
<img alt="Feature Article" src="/DesktopModules/Billboard/Images/BillFeat.gif" />
</td>
<td align="right" style="font-family:Verdana; font-style:italic; color:#0670A2; font-size:12pt; font-weight:bold;">
<asp:Label ID="lblFeatType" runat="server"></asp:Label>
</td>
</tr>
</table>
...
<div class="Bill_Text_Front"><asp:PlaceHolder ID="phBody" runat="server"></asp:PlaceHolder></div>
</td>
</tr>
</table>
</asp:Panel>
...
<div class="Bill_dashed">&nbsp;</div><br />
<asp:Panel ID="pnlComment1" runat="server">
<asp:DataList ID="dlCommentList1" runat="server">
        <ItemTemplate>
...
<td>
 <asp:TextBox ID="tbCommentText" runat="server" Rows="4" TextMode="MultiLine" 
        Width="300px" MaxLength="200" onkeyup='textCounter2(this, this.form.remLenVFeat, 200);' 
                onkeydown="textCounter2(this, this.form.remLenVFeat, 200);" onselect="textCounter2(this, this.form.remLenVFeat, 200);"></asp:TextBox>
</td>
<td valign="top">
<table>
<tr>
<td valign="bottom" class="Bill_Text_Main" style="font-size:10pt;">
<input readonly="readonly" type="text" name="remLenVFeat" size="3" maxlength="3" value="200" /> characters left
</td>
</tr>
</table>
...
<%--<asp:LinkButton ID="btnEdit" runat="server" visible="false" CausesValidation="false">Edit Article</asp:LinkButton>--%>
