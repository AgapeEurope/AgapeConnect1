...
Imports Billboard
Partial Class DesktopModules_Billboard_GetBillboardImage
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) _
        ...
        Dim img = From c In d.Agape_Billboard_Photos Where 1 = 0 Select c
        Try
            img = From c In d.Agape_Billboard_Photos Where c.BillboardPhotoId = CInt(Request.QueryString("PhotoId")) Select c
        Catch ex As Exception
            Dim original As System.Drawing.Image = Bitmap.FromFile(Server.MapPath("~/images/NoImage.jpg"))
        ...
        If img.Count > 0 Then
            For Each r In img
                Try
                    Dim b As Byte() = r.PhotoData.ToArray
