<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditFeature.aspx.vb" Inherits="DesktopModules_Billboard_EditFeature" %>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="tbHeadline" runat="server" Font-Bold="True" Font-Names="Verdana" 
                    Font-Size="20pt" Width="705px"></asp:TextBox><asp:Label ID="lblErrorStarHeadline" runat="server" Text="*" ForeColor="Red" 
        ...
        <td>
            ...
            <table>
               ...
               <tr>
                    ...
                    <td width="400px" style="border-bottom-style: solid; border-bottom-width: thin; border-left-style: solid; border-left-width: thin; border-right-style: solid; border-right-width: thin">
