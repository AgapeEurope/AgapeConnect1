...
<asp:Panel ID="PnlNotEmptyCart" runat="server" Visible="False">
    ...
    <table cellpadding="5" width="100%">
        ...
        <tr>
            <td class="totalTd">
                <asp:Button ID="BtnFinalize" runat="server" ResourceKey="BtnFinalize" CssClass="aButton btnFinalize" />
            </td>
        </tr>
    </table>
</asp:Panel>
...
<asp:LinkButton ID="btnTestPayment" runat="server">TestPayment</asp:LinkButton>
<br />
