...
#Region "Properties and constants"
        ...
        Public Property CallType() As String
            Get
                Return IIf(String.IsNullOrEmpty(Request.Params(CallTypeParamKey)), CallTypeRequest, Request.Params(CallTypeParamKey)) '_CallType
            End Get
            Set(ByVal value As String)
                _CallType = value
            End Set
        ...
        Public Property ReturnURL() As String
            Get
                Return "http://localhost:18967/DesktopModules/AgapeFR/Cart/PaymentProviders/ScelliusPaymentFrame.aspx" '_ReturnURL
            End Get
            Set(ByVal value As String)
                _ReturnURL = value
            End Set
...
#End Region
        ...
        Protected Sub RequestMethod()
            Try
                ...
                LitPageContent.Text = "<form></form>" & api.sipsPaymentCallFunc(theCall)
