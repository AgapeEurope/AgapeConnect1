			...
			<nav>
				...
				<section class="row-fluid">
					<div class="span3 hidden-phone">
						<div id="left_menu"><dnn:GOMENU runat="server" id="dnnGOMENU3" Effect="HTML" ViewLevel="1"  /></div>
						<div class="LeftOutPane" id="LeftOutPane" runat="server"></div>
					</div>
					<div class="span9">
						<div class="bread_style_leftmenu"><span class="bread_icon"></span>You are here : <dnn:BREADCRUMB runat="server" id="dnnBREADCRUMB" Separator="&nbsp;&nbsp;>&nbsp;&nbsp;" CssClass="breadcrumb" RootLevel="0" /></div>
						<div class="pane_layout_leftmenu">
							<section class="row-fluid">
								<div class="span12"><div class="TopPane" id="TopPane" runat="server"></div></div>
							</section>
							<section class="row-fluid">
								<div class="span3">
							...
							<section class="row-fluid">
							  <div class="span12"><div class="ContentPane" id="ContentPane" runat="server"></div></div>
							</section>
						</div>
					</div>
				</section>
