...
<%@ Register TagPrefix="dnn" TagName="STAFFLINKS" Src="~/DesktopModules/AgapeUK/StaffLinks/StaffLinks.ascx" %>
...
<%@ Register TagPrefix="dnn" TagName="NAV" Src="~/Admin/Skins/Nav.ascx" %>
    ...
    <div id="outerContainer" style="width: 100%; margin-left: 0px; margin-right: 0px;"
        align="center">
        <dnn:STAFFLINKS runat="server" id="dnnSTAFFLINKS" />
        <!--<div id="scrollBtn">Hello World</div>-->
