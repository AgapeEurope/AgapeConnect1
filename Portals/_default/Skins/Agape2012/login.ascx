        ...
        <div id="innerContainer" style="width: 975px;">
            ...
            <div class="mainContentContainer">
                <table cellspacing="0" cellpadding="0" border="0" width="100%" class="mainContentContainer">
                    <tr valign="top">
                        <td class="ContentPane" id="TopPane" runat="server" valign="top" align="left" colspan="2"></td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr>
                        <td class="ContentPane" id="BottomPane" runat="server" valign="top" align="right" colspan="2"></td>
                    </tr>
                </table>
            </div>
            <div class="footer">
