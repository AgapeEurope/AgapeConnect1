...
<div  style="width:100% ; margin-left: 0; margin-right: 0 ; ">
   <table cellpadding="0" cellspacing="0" width="100%" style="width: 100%; margin-left: 0; margin-right: 0 ; -moz-border-radius-bottomleft: 15px; -moz-border-radius-bottomright: 15px; -moz-border-radius-topleft: 3px; -moz-border-radius-topright: 3px;"  >
          <tr>
              <td class="green_top_left"><img src="/portals/_default/containers/agapefr/images/GreenTopLeft.gif" alt="" width="16" height="17"   /></td>
              <td class="green_top_middle"></td>
              <td class="green_top_right"><img src="/portals/_default/containers/agapefr/images/GreenTopRight.gif" alt="" width="19" height="17"   /></td>
          </tr>
          <tr>
          ...
          <tr>
              <td class="green_bottom_left"><img src="/portals/_default/containers/agapefr/images/GreenBottomLeft.gif" alt="" / width="16" height="20"   /></td>
              <td class="green_bottom_middle"></td>
              <td class="green_bottom_right"><img src="/portals/_default/containers/agapefr/images/GreenBottomRight.gif" alt="" width="19" height="20"   /></td>
          </tr>
      </table>
</div>
